...
AFL_VERSION=	2.62c
PKGNAME=	afl++-${AFL_VERSION}
DISTNAME=	AFLplusplus-${AFL_VERSION}
...
MAKE_FLAGS+=	PYTHON_INCLUDE="${PYTHON_INCLUDE_CMD:sh}"
MAKE_FLAGS+=	PYTHON_VERSION="${PYTHON_VERSION_CMD:sh}"
MAKE_FLAGS+=	PYTHON_LIB="${PYTHON_LIB_CMD:sh}"
